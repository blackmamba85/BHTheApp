...
{
    public partial class RFIResponses : System.Web.UI.Page
    {
        int rId;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    FailureText.Text = "**There are no responses for this RFI";
                }
                else
                {
                    GetRFIData();
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                strSQL = string.Format(FunctionsHelper.GetFileContents("SQL/RFIResponses.sql"), rId);
